...
public class Camera extends JFrame {
	...
	public Camera(OrderService orderService)
	{
				...
				readQRcode c = new readQRcode();
        			...
        			String data = "query";
                                try{
									...
									String result = orderService.markIn(c.readQR(data));
									System.out.println(result);
									System.out.println("Customer has been checked in");
                                    JOptionPane.showMessageDialog(this, "QRCode output: "+ c.readQR(data));
