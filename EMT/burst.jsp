...
<body>
  ...
  <div class="outside">
     <div class= "blog">
     <h1>EMT Presents: Burst!!!! </h1>
     <img class="flyer"src="Burst.jpg" alt= "flyer">
     <div class="info">
     ...
     <form class="form" method="POST" action="burst.jsp">
     <p>Ticket:<select size="1" name="time">
       <option value="1"  selected="">Early-Bird</option>
       <option value="2">Standard-Entry</option>
       <option value="3">Late-Entry</option>
       <option value="4">VIP</option>
     </select> Quantity:<select size="1" name="amount">
       <option selected="">1</option>
       <option>2</option>
       <option>3</option>
     </select> <input type="submit" value="add to basket" name="VIP1"> </p>
    </form>
    </div>
     </div>
  </div>
<%
 /*   int q = Integer.parseInt(request.getParameter("amount")); */
